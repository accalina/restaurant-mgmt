...
func (_m *OrderItemRepository) Save(tx *gorm.DB, data *entity.OrderItem) (*entity.OrderItem, error) {
	ret := _m.Called(tx, data)

	var r0 *entity.OrderItem
	var r1 error
	if rf, ok := ret.Get(0).(func(*gorm.DB, *entity.OrderItem) (*entity.OrderItem, error)); ok {
		return rf(tx, data)
	}
	if rf, ok := ret.Get(0).(func(*gorm.DB, *entity.OrderItem) *entity.OrderItem); ok {
		r0 = rf(tx, data)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entity.OrderItem)
	...
	if rf, ok := ret.Get(1).(func(*gorm.DB, *entity.OrderItem) error); ok {
		r1 = rf(tx, data)
	} else {
		r1 = ret.Error(1)
	}
