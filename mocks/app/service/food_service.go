...
func (_m *FoodService) CreateFood(ctx context.Context, data model.FoodCreateOrUpdateModel) (*model.FoodResponse, error) {
	ret := _m.Called(ctx, data)

	var r0 *model.FoodResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.FoodCreateOrUpdateModel) (*model.FoodResponse, error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.FoodCreateOrUpdateModel) *model.FoodResponse); ok {
		r0 = rf(ctx, data)
	} else {
		if ret.Get(0) != nil {
...
func (_m *FoodService) UpdateFood(ctx context.Context, data model.FoodCreateOrUpdateModel) (*model.FoodResponse, error) {
	ret := _m.Called(ctx, data)
