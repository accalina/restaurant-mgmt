...
func (_m *MenuService) CreateMenu(ctx context.Context, data model.MenuCreateOrUpdateModel) (*entity.Menu, error) {
	ret := _m.Called(ctx, data)

	var r0 *entity.Menu
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.MenuCreateOrUpdateModel) (*entity.Menu, error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.MenuCreateOrUpdateModel) *entity.Menu); ok {
		r0 = rf(ctx, data)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MenuService) UpdateMenu(ctx context.Context, data model.MenuCreateOrUpdateModel) (*entity.Menu, error) {
	ret := _m.Called(ctx, data)
