...
func (_m *OrderItemService) CreateOrderItem(ctx context.Context, data model.OrderItemCreateOrUpdateModel) (*model.OrderItemResponse, error) {
	ret := _m.Called(ctx, data)

	var r0 *model.OrderItemResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.OrderItemCreateOrUpdateModel) (*model.OrderItemResponse, error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.OrderItemCreateOrUpdateModel) *model.OrderItemResponse); ok {
		r0 = rf(ctx, data)
	} else {
		if ret.Get(0) != nil {
...
func (_m *OrderItemService) UpdateOrderItem(ctx context.Context, data model.OrderItemChangeQtyModel) (*model.OrderItemResponse, error) {
	ret := _m.Called(ctx, data)

	var r0 *model.OrderItemResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.OrderItemChangeQtyModel) (*model.OrderItemResponse, error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.OrderItemChangeQtyModel) *model.OrderItemResponse); ok {
		r0 = rf(ctx, data)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.OrderItemResponse)
	...
	if rf, ok := ret.Get(1).(func(context.Context, model.OrderItemChangeQtyModel) error); ok {
		r1 = rf(ctx, data)
	} else {
		r1 = ret.Error(1)
	}
