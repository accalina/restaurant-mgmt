...
func (_m *OrderService) CreateOrder(ctx context.Context, data model.OrderCreateOrUpdateModel) (*model.OrderResponse, error) {
	ret := _m.Called(ctx, data)

	var r0 *model.OrderResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.OrderCreateOrUpdateModel) (*model.OrderResponse, error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.OrderCreateOrUpdateModel) *model.OrderResponse); ok {
		r0 = rf(ctx, data)
	} else {
		if ret.Get(0) != nil {
...
// DoneOrder provides a mock function with given fields: ctx, data
func (_m *OrderService) DoneOrder(ctx context.Context, data model.OrderDoneModel) (*model.OrderResponse, error) {
	ret := _m.Called(ctx, data)

	var r0 *model.OrderResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.OrderDoneModel) (*model.OrderResponse, error)); ok {
		return rf(ctx, data)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.OrderDoneModel) *model.OrderResponse); ok {
		r0 = rf(ctx, data)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.OrderResponse)
	...
	if rf, ok := ret.Get(1).(func(context.Context, model.OrderDoneModel) error); ok {
		r1 = rf(ctx, data)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *OrderService) UpdateOrder(ctx context.Context, data model.OrderCreateOrUpdateModel) (*model.OrderResponse, error) {
	ret := _m.Called(ctx, data)
